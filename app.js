...
class UI{
    displayProducts(products){
        ...
        products.forEach(product => {
            ...
            <article class="product">
                ...
                <div class="view">
                    <button class="proj-btn" data-id=${product.id}><a href=${product.link}>GET THIS MODEL</a></button>
                </div>
            </article>
    ...
    displayProjectionsButtons(){
        const projectionBtn = [...(document.querySelectorAll(".proj-btn"))]
        projectionBtn.forEach(button => {
            button.addEventListener("click", () => {
                let product = { ...Storage.getProduct(id), amount: 1 };
                this.displayProjections(product);
            })
        })
    }
    getBagButtons(){
